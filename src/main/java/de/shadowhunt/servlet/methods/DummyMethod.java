...
public class DummyMethod extends AbstractWebDavMethod {

    private static final WebDavResponse FORBIDDEN = new StatusResponse(HttpServletResponse.SC_FORBIDDEN);

    public DummyMethod(final String method, final Store store) {
        super(method, store);
    }
