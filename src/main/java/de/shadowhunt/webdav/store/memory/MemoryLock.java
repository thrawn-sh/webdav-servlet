...
@Immutable
final class MemoryLock implements WebDavLock {
    ...
    MemoryLock(final UUID token, final WebDavPath root, final Depth depth, final LockScope scope, final LockType type, final Timeout timeout, final String owner) {
        this.depth = depth;
        this.owner = owner;
        this.root = root;
        this.scope = scope;
    ...
    public boolean equals(final Object obj) {
        ...
        final MemoryLock other = (MemoryLock) obj;
        if (token == null) {
            if (other.token != null) {
                return false;
            }
