...
public class PreconditionTest {
    ...
    public void test_00_empty() throws Exception {
        Mockito.when(request.getOption(Precondition.PRECONDITION_HEADER, "")).thenReturn("");
    ...
    public void test_00_explicit_foreign() throws Exception {
        ...
        Mockito.when(request.getOption(Precondition.PRECONDITION_HEADER, "")).thenReturn(StringUtils.deleteWhitespace(precondition));
        Assert.assertFalse(Precondition.verify(store, request));
    }
